...
export const RetreatData: Retreat[] = [
  {
    ...
    instructors: ["Εύη Πριόνα", "Ανθή Ροροπούλου", "Ραφαέλα Χατζηκώστα", "Νατάσα Πετρίδου"],
    location: "Eco Silence Suites Hotel, Εύβοια",
    image: "/retreats/aerial-yoga-Retreat-6-me-9-6-24.webp",
    imageHorizontal: "/retreats/aerial-yoga-Retreat-6-me-9-6-24-horizontal.webp",
    includes: [
      "3 διανυκτερεύσεις",
  ...
  },
  {
    ...
    imageHorizontal: "/retreats/Aerial-Yoga-Retreat-Montanema-Village-7-9-2-2024-horizontal.webp",
    includes: [
      "2 διανυκτερεύσεις",
      "2 γεύματα την ημέρα (πρωινό κ βραδινό)",
      "Καθημερινές πρακτικές Yoga και Aerial yoga",
  ...
  },
  {
    ...
    imageHorizontal: "/retreats/Flow-&-Fly-retreat-25-29-6-2026-horizontal.webp",
    includes: [
