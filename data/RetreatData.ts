...
export const RetreatData: Retreat[] = [
  ...
  },
  {
    ...
    title: "The Autumn Pause",
    subtitle: "Autumn Escape: Yoga Retreat",
    description:
      "🍂 Αυτό το φθινόπωρο, όταν η φύση ντύνεται στα πιο ζεστά της χρώματα, σας προσκαλούμε σε ένα τριήμερο retreat στο Πήλιο, όπου η κίνηση, η φύση και η σιωπή συναντιούνται. Μια μικρή παύση από την ένταση της καθημερινότητας. Μια ευκαιρία να απομακρυνθούμε για λίγο από τα «πρέπει», από τον θόρυβο και τη βιασύνη. 🧘🏻‍♀️ Μέσα από πρακτικές Vinyasa & Yin Yoga, διαλογισμό, τεχνικές αναπνοής και στιγμές σιωπής, θα δημιουργήσουμε χώρο για χαλάρωση, αποφόρτιση και εσωτερική σύνδεση. 🌿 Και θα αφήσουμε τη φύση να γίνει μέρος της πρακτικής μας. Θα περπατήσουμε στο Μονοπάτι των Κενταύρων, ανάμεσα στα δέντρα και τα νερά του Πηλίου, αφήνοντας το σώμα να κινηθεί και το μυαλό να ησυχάσει. ✨ Ένα φθινοπωρινό pause. Μια επιστροφή στο σώμα. Μια συνάντηση με τον εαυτό μας.",
    date: "13-15 Νοεμβρίου 2026",
    startDate: "2026-11-13",
    instructors: [
      "Εύη Πριόνα",
      "Νατάσα Πετρίδου",
    ],
    location: "Valeni Boutique Hotel & Spa, Πήλιο",
    image: "/retreats/the-autumn-pause-13-me-15-11-26.webp",
    imageHorizontal:
      "/retreats/the-autumn-pause-13-me-15-11-26-horizontal.webp",
    includes: [
      "Πρακτικές Vinyasa Yoga",
      "Διαλογισμό & τεχνικές αναπνοής",
      "Πεζοπορία & εξερεύνηση της φύσης",
    ],
    googleFormLink: "https://docs.google.com/forms/d/e/1FAIpQLSeu0Ruu2FumyIomR1PzU1O183sDFUB0AM2blS4PVehlT27oZg/viewform?usp=dialog",
    partners: [
      {
        name: "OMONYMA",
        description:
    ...
    pricing: {
      earlyBird: {
        endDate: "11/10/26",
        singleRoom: "Επικοινωνήστε μαζί μας",
        doubleRoom: "290€/άτομο",
        tripleRoom: "260€/άτομο",
        quadRoom: "250€/άτομο",
      },
      regular: {
        deposit: "TBA",
        singleRoom: "Επικοινωνήστε μαζί μας",
        doubleRoom: "340€/άτομο",
        tripleRoom: "310€/άτομο",
        quadRoom: "300€/άτομο",
      },
    },
  },
