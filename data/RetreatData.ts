...
export const RetreatData: Retreat[] = [
  ...
  },
  {
    ...
    description:
      `🍂 Αυτό το φθινόπωρο, όταν η φύση ντύνεται στα πιο ζεστά της χρώματα, σας προσκαλούμε σε ένα τριήμερο retreat στο Πήλιο, όπου η κίνηση, η φύση και η σιωπή συναντιούνται. Μια μικρή παύση από την ένταση της καθημερινότητας. Μια ευκαιρία να απομακρυνθούμε για λίγο από τα «πρέπει», από τον θόρυβο και τη βιασύνη.
