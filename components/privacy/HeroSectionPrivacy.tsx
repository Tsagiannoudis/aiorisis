...
const HeroSectionPrivacy = () => {
  const t = useTranslations("HeroSectionPrivacy");
  ...
  return (
    <section className="relative min-h-[450px] h-[55vh] md:h-[65vh] w-full flex items-center overflow-hidden bg-[#F6F1EB]">
      {/* Background Image */}
      ...
      <div className="container mx-auto px-4 pt-14 relative z-10">
        ...
        >
          ...
          <div className="w-24 h-1.5 bg-[#B9007C] rounded-full shadow-lg shadow-[#B9007C]/50 mb-6 md:mb-8" />
          ...
          <div
            className="flex items-center gap-5 mt-10 bg-white border border-gray-200 p-5 rounded-2xl w-fit shadow-sm"
            data-aos="fade-up"
            data-aos-delay="400"
          >
