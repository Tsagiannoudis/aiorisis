...
const HeroSectionContact = () => {
  return (
      ...
      <div className="relative z-10 text-center px-6 mt-24">
        <div className="inline-block bg-black/20 backdrop-blur-md px-8 py-4 rounded-3xl border border-white/10 shadow-xl">
          <h1 className="text-4xl md:text-5xl font-black text-white tracking-tight drop-shadow-[0_2px_6px_rgba(0,0,0,0.5)]">
            Επικοινωνήστε <span className="text-[#B9007C] text-border">Μαζί μας</span>
          </h1>
        </div>
      </div>
