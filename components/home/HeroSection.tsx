...
useEffect(() => {
  ...
  return (
    <>
      <section className="relative z-10 text-gray-900 pt-2 md:pt-1 pb-4 md:pb- bg-[#F5F5F5]">
      ...
      <section className="relative overflow-hidden text-gray-800 pb-16 md:pb-32 md:-mt-35">
        <div className="container mx-auto px-4 max-w-6xl flex flex-col md:flex-row items-center">
          ...
          {/* Φωτογραφία */}
          <div className="relative h-[400px] md:h-[550px] lg:h-[600px] w-full rounded-[2.5rem] overflow-hidden shadow-2xl border border-gray-100" data-aos-delay="300">
            <Image
              src={images[0]}
              alt="Aiorisis Studio"
              fill
