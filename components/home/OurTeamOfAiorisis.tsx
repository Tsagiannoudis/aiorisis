    ...
    <section className="relative py-24 bg-[#85c9bb8d] overflow-hidden">
      ...
      <div className="container relative mx-auto px-4 max-w-7xl z-10">
        ...
        <p className="text-gray-800 font-light leading-relaxed text-center max-w-3xl mx-auto ">
          Η ομάδα της Αιώρησις αποτελείται από έμπειρους και παθιασμένους
          εκπαιδευτές, που είναι αφοσιωμένοι στο να σας βοηθήσουν να
          εξερευνήσετε τις δυνατότητες του σώματός σας και να ανακαλύψετε τη
          χαρά της κίνησης στον αέρα.
        </p>
            ...
            >
              ...
              <div className="text-center">
                ...
                {/* <p className="text-gray-800 text-sm mt-2 leading-relaxed">
                  {getSpecialtyNames(teacher.specialties).map(
                    (specialty, idx, arr) => (
                      <span key={idx}>
                        {specialty}
                        {idx < arr.length - 1 && <br />}
